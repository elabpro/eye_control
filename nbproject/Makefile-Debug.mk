...
${TESTDIR}/tests/InputControlTest.o: tests/InputControlTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/InputControlTest.o tests/InputControlTest.cpp


${TESTDIR}/tests/SettingsTest.o: tests/SettingsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SettingsTest.o tests/SettingsTest.cpp
